...
namespace HimeLib
{
    public class LocationConverter
    {
        ...
        /// <summary>
        /// LocationConverter 建構函數
        /// </summary>
        /// <param name="sensorCorners">感測器角落座標，按照順序：右上、右下、左下、左上</param>
        /// <param name="worldCorners">世界座標角落</param>
        public LocationConverter(Vector2[] sensorCorners, Vector3[] worldCorners)
        {
